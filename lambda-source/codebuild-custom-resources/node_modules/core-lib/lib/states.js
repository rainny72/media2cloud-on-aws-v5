...
module.exports = {
  ...
  PreparePerceptualHashIterations: 'prepare-perceptual-hash-iterations',
  ComputePerceptualHash: 'compute-perceptual-hash',
  MergePerceptualHashIterations: 'merge-perceptual-hash-iterations',
  // imageinfo
  ...
  RunTitanEmbeddings: 'run-titan-embeddings',
