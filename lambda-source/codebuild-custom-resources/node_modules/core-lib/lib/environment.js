...
module.exports = {
  ...
  StateMachines: {
    ...
    // v5
    FrameExtraction: `${ResourcePrefix}-frame-extraction`,
    AudioExtraction: `${ResourcePrefix}-audio-extraction`,
    AdvancedAudioAnalysis: `${ResourcePrefix}-analysis-audio-advanced`,
    AdvancedVideoAnalysis: `${ResourcePrefix}-analysis-video-advanced`,
    FaceRecognition: `${ResourcePrefix}-face-recognition`,
  },
  DynamoDB: {
    Ingest: {
