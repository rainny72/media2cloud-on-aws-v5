...
const de_CreateDBClusterEndpointOutput = (output, context) => {
    const contents = {};
...
const de_DeleteDBClusterEndpointOutput = (output, context) => {
    const contents = {};
    if (output[_DBCEI] != null) {
        contents[_DBCEI] = __expectString(output[_DBCEI]);
    }
...
const de_ModifyDBClusterEndpointOutput = (output, context) => {
    const contents = {};
    if (output[_DBCEI] != null) {
        contents[_DBCEI] = __expectString(output[_DBCEI]);
    }
