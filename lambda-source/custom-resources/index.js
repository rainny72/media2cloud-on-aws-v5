  ...
  try {
    ...
    switch (resource) {
      ...
      case 'ConfigureBucketNotification':
        ...
        break;
      case 'CheckBucketRegion':
        handler = require('./lib/s3/index').CheckBucketRegion;
        break;
      /* mediaconvert */
      ...
      case 'ECRDescribeImages':
        ...
        break;
      // contextual
      case 'CopyBuiltinTasks':
        handler = require('./lib/contextual').CopyBuiltinTasks;
        break;
      // ffmpeg
      case 'ConfirmFFmpegAgreeAndProceed':
        handler = require('./lib/ffmpeg').ConfirmFFmpegAgreeAndProceed;
        break;
      // bedrock
      case 'CreateModelList':
        handler = require('./lib/bedrock').CreateModelList;
        break;
      // generic (supress exception on Delete event)
      default:
        handler = require('./lib/generic').GenericHandler;
        break;
    }
